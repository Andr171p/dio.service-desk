...
- **Workflow / Transition / Rule** — доменные сущности.
  Хранят только декларативное описание (type_ + config).
- **Rule Registry** — связывает строковый ``type_`` правила
...
- Если rule.type_ не зарегистрирован или kind не совпадает —
